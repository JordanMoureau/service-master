...
export default function Home() {
  <NextSeo
    title="Disaster Restoration Spokane WA | Water, Fire & Mold | ServiceMaster by Compass"
    description="Top-rated disaster restoration in Spokane & Coeur d’Alene: water damage clean up, fire damage restoration, and mold remediation/removal. 24/7 emergency service. Call (509) 646-7488."
    ...
    additionalMetaTags={[
      {
        ...
        content: [
          ...
          "disaster restoration Spokane",
          "water mitigation Spokane",
          "Spokane fire restoration",
        ].join(", "),
      },
    ]}
    openGraph={{
      ...
      description:
        "24/7 emergency water, fire, and mold damage restoration in Spokane, Spokane Valley, and Coeur d’Alene.",
      locale: "en_US",
      images: [
        {
          url: "https://smcfireandwater.com/og/home-hero.jpg",
          width: 1200,
          height: 630,
          alt: "Water, fire, and mold restoration in Spokane & Coeur d’Alene",
        },
      ],
    }}
    twitter={{
      cardType: "summary_large_image",
      handle: "@", // add if you have one
      site: "@", // add if you have one
    }}
    additionalLinkTags={[
      { rel: "canonical", href: "https://smcfireandwater.com/" },
    ]}
    robotsProps={{
      nosnippet: false,
      notranslate: true,
  ...
  <JsonLd
    data={{
      ...
      url: "https://smcfireandwater.com/",
      image: "https://smcfireandwater.com/og/home-hero.jpg",
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          {
            "@type": "OfferCatalog",
            name: "Water Damage Restoration & Clean Up",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "Water Damage Clean Up Spokane Valley WA",
                  areaServed: "Spokane Valley, WA",
                  serviceType: "Water Mitigation & Structural Drying",
                },
              },
            ],
          },
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  "@type": "Service",
                  name: "Fire Damage Restoration Spokane WA",
                  areaServed: "Spokane, WA",
                  serviceType: "Fire & Smoke Cleanup, Odor Removal",
                },
              },
            ],
          },
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  "@type": "Service",
                  name: "Mold Remediation and Removal Spokane WA",
                  areaServed: "Spokane, WA",
                  serviceType: "Mold Inspection, Abatement, Remediation",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "Mold Abatement Service Coeur d’Alene ID",
                  areaServed: "Coeur d’Alene, ID",
                  serviceType: "Mold Abatement & Removal",
                },
              },
            ],
          },
          {
            "@type": "OfferCatalog",
            name: "Emergency Flood & Storm",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "Emergency Flood Cleanup Coeur d’Alene ID",
                  areaServed: "Coeur d’Alene, ID",
  ...
  {
    /* Optional: WebSite + SearchAction for sitelinks */
  }
  <JsonLd
    data={{
      "@context": "https://schema.org",
